...
static void run_pid_control_pos(int tacho_now, int tacho_set, float dt);
...
int mcpwm_foc_get_pid_pos_set(void) {
...
static void run_pid_control_pos(int tacho_now, int tacho_set, float dt) {
	...
	// Compute parameters
	float error = tacho_set - tacho_now;
	...
	// I-term wind-up protection
	utils_truncate_number(&i_term, -2000, 2000);
